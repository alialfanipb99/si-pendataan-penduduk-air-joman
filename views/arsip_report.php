        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Data Warga</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">NIK</th><th>Nama Lengkap</th><th width="14%"><center>Tempat/Tanggal Lahir</center></th><th width="15%">Jenis Kelamin</th><th width="10%">Desa</th><th width="10%">Dusun</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td colspan="9">
                                    <a href="report/arsip_semua.php" target="_blank" class="btn btn-info btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Data Warga
