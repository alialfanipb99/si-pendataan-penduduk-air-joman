            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        ...
                        <tr>
                            <td>Kode Surat</td> <td><?= $data['kode_surat'] ?></td>
                        </tr>
                        <tr>
                            <td>Tanggal Surat</td> <td><?= $data['tgl_surat'] ?></td>
                        </tr>
						<tr>
                            <td>Tanggal Masuk/Keluar Surat</td> <td><?= $data['tgl_masuk_keluar'] ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Disposisi</td> <td><?= $data['dispos'] ?></td>
                        </tr>
                ...
                <div class="panel-footer">
                    <a href="?page=p_surat&actions=tampil" class="btn btn-success btn-sm">
